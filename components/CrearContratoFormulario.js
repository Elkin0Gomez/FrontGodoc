...
const CrearContratosFormularios = ()=>{
  return(
`
<div class="card" style="margin-left: 23%; margin-top: 3%; width: 45rem;">
    <div class="card-body">
      <center><h3>Datos del Empleado</h3></center>
      <br>
        <form>
            ...
            <!-- Submit button -->
            <center><button type="submit" class="btn btn-primary btn-block mb-4">crear contrato</button></center>
          </form>
    </div>
  </div>
  <br>
...
export {CrearContratosFormularios}